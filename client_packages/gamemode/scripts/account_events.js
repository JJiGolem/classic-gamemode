exports = (menu) => {
    ...
    mp.events.add("confirmEmail", (email, login) => {
        mp.events.callRemote("confirmEmail", email, login);
    });
    ...
    mp.events.add("confirmEmailCode", (loginOrEmail, code) => {
        mp.events.callRemote(`confirmEmailCode`, loginOrEmail, code);
    });
