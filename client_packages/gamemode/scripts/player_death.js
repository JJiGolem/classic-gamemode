...
mp.events.add("render", () => {
    ...
    if (healthData.lastHealth > 10 && healthData.lastHealth > health && health <= 10 && health > 0 && !localPlayer.isSwimming()) {
        if (localPlayer.getVariable("gangwar")) return;
    ...
    if (healthData.lastHealth <= 10 && healthData.lastHealth < health && health > 10 && !isLocalPlayerInHospitalBed()) {
        localPlayer.clearTasksImmediately();
