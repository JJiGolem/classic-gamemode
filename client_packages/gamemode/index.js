        ...
        mp.events.add('browserDomReady', (browser) => {
            if (browser == menu) {
                mp.gui.execute("window.location = 'package://gamemode/chat/index.html'");
								...
								// Init helpers
								mp.helpers = {
									animation: require("gamemode/scripts/helpers/animHelper.js"),
									camera: require("gamemode/scripts/helpers/classes/camera.js"),
									cameraRotator: require("gamemode/scripts/helpers/cameraRotator.js"),
									controlsDisabler: require("gamemode/scripts/helpers/controlsDisabler.js"),
									interior: require("gamemode/scripts/helpers/interiorHelper.js"),
									instructionButtonsDrawler: require("gamemode/scripts/helpers/instructionButtonsDrawler.js"),
									loadingPrompt: require("gamemode/scripts/helpers/loadingPrompt"),
									ped: require("gamemode/scripts/helpers/pedHelper.js"),
									scaleform: require("gamemode/scripts/helpers/scaleformHelper.js"),
									screen: require("gamemode/scripts/helpers/screenHelper"),
									string: require("gamemode/scripts/helpers/stringHelper.js"),
									vehicle: require("gamemode/scripts/helpers/vehicleHelper")
								};
                // Init events.
                ...
                //require('gamemode/scripts/bandTablet_events.js')(menu);
                ...
                require('gamemode/scripts/gang_storage.js')(menu);
                ...
                require('gamemode/scripts/hospital.js');
                require('gamemode/scripts/clothesShop.js');
                require('gamemode/scripts/bandZones_events.js')(menu);
...
function setPassiveMode(entity, enable) {
    if (enable) entity.setAlpha(100);
