...
import { setOpacityChat, setFocusChat, pushMessage, setTagsChat, showChat } from '../../actions/chat.js';
...
class Chat extends React.Component {
    ...
    //     ];
    //
    //     this.props.setTagsChat(tags);
    //     this.props.showChat(true);
    //     this.props.setOpacityChat(1);
    //
    //     setTimeout(() => {
    //         this.props.pushMessage('!{#ffffff}hello')
    //     }, 2000);
    //
    //     setTimeout(() => {
