...
import {deleteContact, renameContact} from "../actions/action.info";
...
class ContactPage extends Component {
    ...
    callContact() {
        const { addApp, contact } = this.props;
                ...
                <div className="back_page-phone-react">
                    <div className="head_app-phone-react" style={{ height: '40%' }}>
                        ...
                        <div className='panel_call_mess_contact-phone-react'>
                            <div className='button_panel_contact-phone-react' style={{ background: '#31e15f' }} onClick={() => this.callContact()}>
                                <svg xmlns="http://www.w3.org/2000/svg" onClick={() => this.callContact()} width="100%" height="55%" viewBox="0 0 45.327 45.748" style={{ marginTop: '7%' }}>
