...
class TaxiClient extends Component {
    constructor(props) {
        ...
        this.getOrderPage = this.getOrderPage.bind(this);
    ...
    getSearchButton() {
        return (
            <div className='search_button_taxi-phone-react' onClick={this.createOrder.bind(this)}>
                Заказать такси
            </div>
        )
    }
    ...
    getSearchPanel() {
        return (
            <div className='search_panel_taxi-phone-react'>
    ...
    getOrderInfo() {
        ...
        return (
            <Fragment>
                ...
                <div>{ taxi.answer.name }</div>
                <div>на { taxi.answer.model } с номером { taxi.answer.number }</div>
            </Fragment>
        )
    }
    ...
    getLocation() {
        ...
        if (taxi.location) {
            return (
                <Fragment>
                    <div style={{ fontSize: '1.5em' }}>{ taxi.location.street }</div>
                    <div>{ taxi.location.area }</div>
                </Fragment>
            )
        } else {
            return (
                <span>Идет определение местоположения...</span>
            )
        }
    }
    ...
    getStartPage() {
        ...
        return (
            <Fragment>
                {
                    taxi.location && taxi.isSearch && this.getSearchPanel()
                }
                <div className='back_taxi-phone-react' style={{ height: taxi.isSearch && '65%' }}></div>
                ...
                <div className='block_location_taxi-phone-react'>
                    ...
                    <div className='location_taxi-phone-react'>
                        { this.getLocation() }
                    </div>
                </div>
                {
                    taxi.location && !taxi.isSearch && this.getSearchButton()
                }
            </Fragment>
        )
    }
        ...
        return (
            <Fragment>
                <div className='back_page-phone-react'>
                    { taxi.answer == null ? this.getStartPage() : this.getOrderPage() }
