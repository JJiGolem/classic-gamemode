...
import {disableHomePhone, setSellInfoHouse, setSellStatusHouse} from "../../actions/action.info";
            ...
            return (
                <Fragment>
                    ...
                    <div style={{ marginTop: '20%' }}>
                        ...
                        <div style={{ marginTop: '5%' }}>Покупатель: { info.houses[0].ansSell.nick }</div>
                        <div>Сумма: <span style={{ color: '#30af25' }}>${ String(info.houses[0].ansSell.price).toLocaleString('ru-RU') }</span></div>
                    </div>
