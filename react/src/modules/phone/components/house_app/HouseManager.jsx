                    ...
                    <div className='manager_buttons-phone-react'>
                        ...
                        <div className='manager_button-phone-react' onClick={() => addApp({name: 'SellState', form: <SellState />})}>
                            <div style={{ marginBottom: '6%' }}>
                                <svg id="state" xmlns="http://www.w3.org/2000/svg" width="50%" height="50%" viewBox="0 0 33.899 33.727">
                    ...
                    <div className='house_buttons-phone-react' style={{ bottom: '3%', position: 'absolute'}}>
                        <div className='house_button-phone-react' onClick={this.toInfoPage.bind(this)}>
                            <span className='ico_button_house-phone-react'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40%" height="40%" viewBox="0 0 7.885 17.142" style={{marginLeft: '5px'}}>
