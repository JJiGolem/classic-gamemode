...
function initMpUtils() {
    ...
    mp.clearGangRoobers = () => {
      Gangs.tie.roobers = []
      Gangs.tie.patients = [];
      console.log("[Банды] Обнулены массивы для ограблений банд!");
    }
    //-----------------------------------------------//
...
function initBlackMarket() {
    var pos = new mp.Vector3(1538.55, 1699.69, 109.706);
    pos.z -= 1.5;
    var marker = mp.markers.new(1, pos, 0, {});
    marker.visible = false;
    var blip = mp.blips.new(500, pos, { alpha: 255, scale: 0.7, color: 4, name: "Авто-перекупщик", shortRange: true });
    marker.blip = blip;
    //для стриминга
