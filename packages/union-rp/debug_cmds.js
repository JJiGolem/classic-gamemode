  module.exports = {
    ...
    "capt": {
        ...
        syntax: "",
        handler: (player, args) => {
            mp.events.call("band.capture.start", player);
        }
    },
    "capt_stop": {
        ...
        syntax: "[zoneId]:n",
        handler: (player, args) => {
            mp.bandZones[args[0]].stopCapture();
        }
    },
    "band_rect": {
        ...
        handler: (player, args) => {
            player.call(`bandZones.setRect`, args);
        }
    },
    "zone": {
    ...
    "gangwar": {
        ...
        handler: (player, args) => {
            ...
            if (player.getVariable("gangwar")) player.setVariable("gangwar", null);
            else player.setVariable("gangwar", zone.id);
            terminal.info(`gangwar: ${player.getVariable("gangwar")}`, player)
        }
    },
}
