const doorsInfo = [
	...
	// Склад медикаментов
	{ model: mp.joaat("v_ilev_bl_shutter2"), position: new mp.Vector3(3628, 3747, 28), locked: false },
	{ model: mp.joaat("v_ilev_bl_shutter2"), position: new mp.Vector3(3621, 3752, 28), locked: false },
];
