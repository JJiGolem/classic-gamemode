...
module.exports = {
    ...
    "biz.sell": (player, bizId, cost) => {
        ...
        console.log(player.dist(new mp.Vector3(info.pickupX, info.pickupY, info.pickupZ)));
        console.log(buyer.dist(new mp.Vector3(info.pickupX, info.pickupY, info.pickupZ)));
